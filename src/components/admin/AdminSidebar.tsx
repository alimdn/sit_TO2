...
import { LayoutTemplate, CreditCard, ShoppingBag, MessageSquare, Star, Share2, Wallet, Settings } from 'lucide-react'
...
const tabs: { id: AdminTab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'testimonials', label: 'Reviews', icon: <Star className="h-4 w-4" /> },
